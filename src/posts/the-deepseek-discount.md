...
1. **The frontier could pull away again.** If Western labs open a real capability lead on tasks that matter, such as long-horizon agents and hard reasoning, "90% as good" stops being good enough and the discount stops mattering. Commodity pricing only works while it's a commodity.
